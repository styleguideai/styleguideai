...
echo -e "\033[0;31mPlease upload all of your style guides that are .pdf file(s) to the current working directory:\033[0m"
echo -e "\033[0;94m  $(pwd)\033[0m"
echo ""

read -p $'\033[0;92mWhen you uploaded the file(s), press \033[1;92mEnter\033[0;92m: \033[0m'
